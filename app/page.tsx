...
export default function Home() {
	return (
		<div className="flex flex-col items-center justify-center h-screen w-screen overflow-hidden bg-gradient-to-tl from-[#002451] via-zinc-600/20 to-[#002451]">
			...
			<span className="text-[120px]" >{"{"}</span>{	" Dalton Wais " }<span className="text-[120px]">{"}"}</span>
			</h1>
			...
			<div className="my-12 text-center animate-fade-in">
				<h2 className="text-lg text-zinc-300 flex flex-grow">
					<div className="mx-12"><a href="/services/fcto" >Fractional CTO</a></div> <div>💻</div> <div className="mx-12"> Technology Consultant </div><div> 🚀 </div><div className="mx-12"> Software Engineer</div>
				</h2>
